(function(){
  var icon = "chrome://secretsocial/skin/secretsocial-16.png";
  ...
  var goToSecretSocial = function() {
    ...
    window.open(shhFinalUrl,"ss-window");
  };

  var shhMessageTemplate = '<a class="uiButton uiButtonSuppressed uiButtonNoText ss-message-placed uiTooltip\
  ...
  var setupHovercardSSLink = function(evt) {
  ...
  var setMessagingSSLink = function() {
    var message = encodeURIComponent(messagingComposer.
      getElementsByClassName('UIComposer_TextArea')[0].value);
          ...
          sendMessageLI.addEventListener('click', whenReady({
            ...
            condition: function() {
              var messagingComposerNX = document.
                getElementsByClassName("MessageComposer");
