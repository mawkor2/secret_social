...
var icon = "chrome://secretsocial/skin/goprivate.png";
...
function createAction(tweet) {
  ...
  var topic = tweet.getElementsByClassName('tweet-text')[0].textContent;
  ...
  setTimeout(function () {
    ...
    for (var i = 0; i < originals.length; i ++) {
      if (!originals[i].getAttribute('data-goprivate')) {
        var originalsChildren = originals[i].children;
        createButton(originalsChildren[originalsChildren.length - 1]);
